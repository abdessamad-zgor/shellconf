...
export function getTerminal() {
  ...
  if (type() != "Windows_NT") {
    ...
    console.log(ok)
    if (ok.includes(TERMINALS.ALACRITTY.toLowerCase())) terminal = TERMINALS.ALACRITTY
    else if (ok.includes(TERMINALS.GNOME.toLowerCase())) terminal = TERMINALS.GNOME
    else if (ok.includes(TERMINALS.ITERM.toLowerCase())) terminal = TERMINALS.ITERM
